...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($user->hasRole('judge')) return redirect()->route('judge.dashboard');
        ...
        if ($user->hasRole('info_desk')) return redirect()->route('info_desk.dashboard');
        if ($user->hasRole('court_clerk')) return redirect()->route('court_clerk.dashboard');
