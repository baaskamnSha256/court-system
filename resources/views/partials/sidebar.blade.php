...
<nav class="p-3 space-y-1 overflow-y-auto flex-1">
    ...
    <a href="{{ route('dashboard') }}" class="{{ $current === 'dashboard' ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }} flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors">
    ...
    @role('admin')
        ...
        <a href="{{ route('admin.matter-categories.index') }}" class="{{ str_starts_with($current, 'admin.matter-categories') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }} flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors pl-6">
        ...
        <a href="{{ route('admin.users.index') }}" class="{{ str_starts_with($current, 'admin.users') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }} flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors pl-6">
