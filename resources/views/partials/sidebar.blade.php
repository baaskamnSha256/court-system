...
<nav class="p-3 space-y-1 overflow-y-auto flex-1">
    ...
    @hasanyrole('admin|head_of_department')
        ...
        <a href="{{ route('admin.activity-logs.index') }}" class="{{ str_starts_with($current, 'admin.activity-logs') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }} flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors pl-6">
