...
/**
 * Laravel Fortify-ийн замууд (нэвтрэх/гарахыг routes/web.php-ийн LoginController хариуцна).
 *
 * @see Laravel\Fortify\Fortify::$registersRoutes
 */
...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
    ...
    // Нууц үг сэргээх: forgot link routes/web.php; зөвхөн шинэ нууц үгийн хуудас Fortify.
